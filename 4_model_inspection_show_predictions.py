        ...
        for horizon_dir_name in os.listdir(target_path):
            if horizon_dir_name.startswith("horizon_"):
                ...
                if models_to_plot_pred:
                    ...
                    plt.show()
                    # Save the figure under plots with target in the filename
                    fig_pred.savefig(os.path.join("plots", f"predictions_{current_target_variable}_horizon_{horizon_val}.png"), bbox_inches='tight')
